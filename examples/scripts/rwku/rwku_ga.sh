...
python infer.py --input_file $storage_dir/data/rwku/test.csv --output_file $storage_dir/data/rwku/test_ga_output.jsonl \
--model_name $storage_dir/models/ga_model/final_checkpoint \
