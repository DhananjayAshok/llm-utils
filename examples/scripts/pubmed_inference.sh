...
print("Base Rate: \n", df["answer"].value_counts(normalize=True)* 100)
df["correct"] = df["binary_output"] == df["answer"]
print("LLama3-Instruct Model Achieves PubmedQA Accuracy: ", (df.groupby("answer")['correct'].mean()*100))
EOF