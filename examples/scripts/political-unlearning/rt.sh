...
python train.py --training_kind sft --model_name meta-llama/Meta-Llama-3.1-8B-Instruct \
...
--run_name political-dem-rt \
--push_to_hub True --hub_model_id unlearn_democrats_Llama3_8b_rt
...
--lora_target_modules k_proj, v_proj, o_proj \
--save_strategy epoch --save_steps 0.5 \
--run_name political-rep-rt \
--push_to_hub True --hub_model_id unlearn_republicans_Llama3_8b_rt
