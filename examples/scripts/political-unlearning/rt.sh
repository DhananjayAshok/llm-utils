...
python train.py --training_kind sft --output_column chosen --model_name $model_name \
...
--run_name political-dem-rt-$model_short_name \
--push_to_hub True --hub_model_id unlearn_democrats_${model_short_name}_rt
...
--lora_target_modules k_proj, v_proj, o_proj \
--save_strategy epoch --save_steps 0.5 \
--run_name political-rep-rt-$model_short_name \
--push_to_hub True --hub_model_id unlearn_republicans_${model_short_name}_rt
