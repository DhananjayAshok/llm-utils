...
for test_lm in ${test_lms[@]}; do
    ...
    accelerate launch train.py --training_kind clf --model_name $test_lm \
    --output_dir $storage_dir/models/tmp_clf_model --max_steps 10  \
    --train_file tmp_test_data/tmp_clf.csv --train_validation_split 0.85 --validation_test_split 0.1 --output_column label  \
    ...
    --run_name test-clf-$test_lm --per_device_train_batch_size 2 --per_device_eval_batch_size 2 \
